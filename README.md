...
This mini-framework is a simplified version of the cleanRL repository that adds a minigrid-style Gymnasium environment for a robot and aims for easy execution of DQN and D2CBRL (DQN_CBR) algorithms on it.
